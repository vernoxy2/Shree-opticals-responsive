...
const ValuesAndMission = () => {
  return (
    <div className="py-10 md:py-20 space-y-5 md:space-y-8">
      ...
      <div className="container grid grid-cols-1 lg:grid-cols-2 items-center justify-center gap-8">
        <div className="flex flex-col gap-4 md:gap-7 text-center lg:text-left">
          <h2 className="text-2xl md:text-4xl 2xl:text-5xl font-normal text-[#06213C] font-kaisei_Decol">
            Clarity in Vision, Integrity in Service
          </h2>
          <p className="text-base md:text-xl xl:text-2xl font-normal text-[#334155] font-kanit leading-relaxed">
