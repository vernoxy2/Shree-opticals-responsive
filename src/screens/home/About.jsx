...
const About = () => {
  return (
    <div className="py-10 md:py-20 space-y-4 md:space-y-8">
      ...
      {/* Main Container */}
      <div className="container grid grid-cols-1 lg:grid-cols-2 items-center gap-y-14 ">
        {/* Left Text Block */}
        <div className="flex flex-col justify-center items-center md:items-start gap-4 md:gap-8 xl:gap-12 text-center md:text-start order-2 lg:order-1">
          ...
          {/* Description */}
          <p className="text-xs md:text-xl 2xl:text-2xl text-[#334155] font-semibold leading-tight">
