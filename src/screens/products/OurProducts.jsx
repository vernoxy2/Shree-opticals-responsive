...
const OurProducts = () => {
  ...
  return (
    ...
    >
      ...
      <button
        className="lg:hidden fixed bottom-6 right-6 z-50 bg-[#BBCED4] text-black px-4 py-3 rounded-full shadow-lg flex items-center gap-2"
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 md:gap-6 gap-y-4 container mx-auto">
        {/* Sidebar (Desktop) */}
        <div className="hidden lg:block col-span-1 space-y-6 bg-[#BBCED4] p-4 rounded-lg h-fit w-full">
          <FiltersUI
