  ...
  return (
    <div className="w-full flex flex-row items-center justify-start my-[100px]">
        ...
        <div className="w-[60%] flex flex-col items-center justify-center text-center gap-[30px]">
          <h1 className="text-[68px] text-[#06213c] font-normal font-kaisei_Decol">Collection For Men</h1>
          ...
          <a href="/mens-product" className="w-[200px] h-[50px] bg-[#06213c] text-[20px] text-white flex items-center justify-center font-kanit no-underline">
            More Product
          </a>
        </div>
      </div>
